...
export default function Tasks() {
  ...
  return <>
    <PageHeader title="My Tasks" description="Actions generated from confirmed documents and tasks you create yourself." action={<Button onClick={() => { setFormError(''); setEdit({ id: 'new', title: '', priorityOverride: '', status: 'Pending' }); }}><Plus size={16} />New task</Button>} />
