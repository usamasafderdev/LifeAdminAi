...
async function run() {
  ...
  try {
    ...
    check(valid.body.created === 1 && valid.body.tasks[0].source === 'ai_confirmed' && valid.body.tasks[0].dueDate, '7. Valid task generation preserves due date');
